...
<div class="designer">
    <div class="card controls">
        ...
        <label for="g-gtin">GTIN / EAN <span class="muted">(8, 12, 13 oder 14 Ziffern)</span></label>
        <input id="g-gtin" type="text" inputmode="numeric" maxlength="20" autofocus
               placeholder="4006381333931">

        <div class="two-col">
            <div>
                <label for="g-lot">Charge <span class="muted">(optional)</span></label>
                <input id="g-lot" type="text" maxlength="20" placeholder="LOT-42">
            </div>
            <div>
                <label for="g-serial">Seriennummer <span class="muted">(optional)</span></label>
                <input id="g-serial" type="text" maxlength="20" placeholder="SN-0001">
            </div>
        </div>

        <label for="g-mhd">Mindestens haltbar bis <span class="muted">(optional)</span></label>
        <input id="g-mhd" type="date">

        <label for="g-resolver">Auflösungsdienst <span class="muted">(optional – leer = id.gs1.org)</span></label>
        <input id="g-resolver" type="text" placeholder="https://id.gs1.org">
        <p class="muted small">Hier steht, unter welcher Adresse der Code aufgelöst wird. Wer
        eine eigene Domain einträgt, muss dort selbst dafür sorgen, dass beim Scannen etwas
        Sinnvolles erscheint.</p>
    ...
    <div class="card preview">
        ...
        <div id="preview-stage" style="display:inline-block; padding:1.2rem; border-radius:6px; background:#FAFCF6;">
            <img id="g-preview" alt="GS1-QR-Code-Vorschau" width="300">
        </div>
        ...
        <div class="qr-links">
            ...
            <button class="btn btn-small" type="button" id="g-png">PNG (1024&nbsp;px)</button>
            <button class="btn btn-small" type="button" id="g-pdf">PDF (Druck)</button>
            <button class="btn btn-small" type="button" id="g-eps" title="EPS für Satz und Belichtung">EPS</button>
        </div>
        <p class="muted small">Die Angaben werden nur zur Erzeugung der Grafik verwendet und
        <strong>nicht gespeichert</strong>. Der Code enthält die Adresse selbst – er funktioniert
        für immer, ganz ohne uns.</p>
    </div>
</div>
</div>
